...
function FindMSBuild(pathToVSWhere) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec(vsWhereExe, ['-property', 'installationPath', '-prerelease', '-version', '(16.0^,19.0^)'], options2);
        if (vs2019Path === "") {
            core.setFailed("Unable to find VS2019");
        }
        else {
            yield exec.exec(`${vs2019Path}\\VC\\Auxiliary\\Build\\vcvars${process.env.platform === 'x64' ? '64' : '32'}.bat`);
